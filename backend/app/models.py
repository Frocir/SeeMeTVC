...
class Workflow(Base):
    ...
    brand: Mapped[str] = mapped_column(String(120), default="GlamPilot")
...
class AgentSession(Base):
    ...
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id"), index=True)
    skill_id: Mapped[str] = mapped_column(String(64), default="seedance-tvc")
    work_mode: Mapped[str] = mapped_column(String(16), default="auto")
